...
function NewFactForm({ setFacts, setShowForm }) {
  ...
  async function handelSubmit(e) {
    ...
    if (
      ...
      //upload fact to supabase and recieve the new fact obj
      setIsUploading(true);
  ...
  return (
    <form className="fact-form" onSubmit={handelSubmit}>
      ...
      <input
        value={source}
        type="text"
        placeholder="Trustworthy scorce..."
      ...
      <button className="btn btn-large" disables={isUploading}>
        Post
      </button>
    </form>
  );
...
function Fact({ fact, setFacts }) {
  ...
  const isDisputed =
    fact.votesInteresting + fact.votesMindblowing < fact.votesFault;
  ...
  return (
    <li key={fact.id} className="fact">
      ...
      <div className="vote-buttons">
        ...
        <button onClick={() => handelVote("votesFault")} disabled={isUpdating}>
          ⛔ {fact.votesFault}
        </button>
      </div>
    </li>
